...
# Replate the . and - of education and the unknown to np,NaN
client["education"] = client["education"].str.replace(".", "_")
client["education"] = client["education"].replace("unknown", np.NaN)

# Replace the . and - of job
...
# Add year column because we dont have year in data
campaign["year"] = "2022"
...
# we combine the year month and day to one column 
